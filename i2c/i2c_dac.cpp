...
bool I2sDAC :: begin(int sampleRate, int dataPort, int bclk, int wsel, in dout)
{
    port = dataport;

    i2s_configs_t i2s_config = {
    ...
    i2s_zero_dma_bufer((i2s_port_t)port);
...
void I2sDAC :: writeSample(int16_t left, int16_t right)
{
    ...
    //retry the sample until it is accepted
